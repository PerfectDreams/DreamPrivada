...
<a href="https://github.com/PerfectDreams/DreamPrivada/LICENSE"><img src="https://img.shields.io/badge/license-AGPL%20v3-orange.svg"></a>
</p>
...
* Eu não irei dar suporte caso você queria usar o plugin no seu servidor sem dar nada em troca para o PerfectDreams, lembre-se, a licença do projeto é [AGPL v3](https://github.com/PerfectDreams/DreamPrivada/LICENSE), você é **obrigado a deixar todas as suas alterações no projeto públicas**.
...
6. Faça ```git clone https://github.com/PerfectDreams/DreamPrivada.git``` em alguma pasta no seu computador.
